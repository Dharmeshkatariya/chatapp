...
import 'package:chat_flutter_app/binding/user_profile_binding.dart';
...
import 'package:chat_flutter_app/screen/user_profile_screen.dart';
...
class PageRoutes {
  static final pages = [
    ...
    // ),
    GetPage(
      name: NameRoutes.userProfileScreen,
